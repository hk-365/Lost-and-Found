...
const AddCard = ({ open, onClose, setItems }) => {
  ...
  const handleImageUpload = async (e) => {
    ...
    try {
      ...
      const res = await axios.post(
        'https://lost-and-found-ziq5.onrender.com/items/upload',
        data
      );
  ...
  const handleSubmit = async () => {
    try {
      ...
      const response = await axios.post('https://lost-and-found-ziq5.onrender.com/items', formData, {
        headers: {
          Authorization: `Bearer ${token}`,
        },
      });
      const updated = await axios.get('https://lost-and-found-ziq5.onrender.com/items');
